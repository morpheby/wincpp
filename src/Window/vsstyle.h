...
//
//  TOUCHSCROLLBARSTYLE class parts and states
//
#ifndef VSCLASS_TOUCHSCROLLBARSTYLE
#define VSCLASS_TOUCHSCROLLBARSTYLE	L"TOUCHSCROLLBARSTYLE"
#endif

#ifndef VSCLASS_TOUCHSCROLLBAR
#define VSCLASS_TOUCHSCROLLBAR	L"TOUCHSCROLLBAR"
#endif

enum TOUCHSCROLLBARPARTS {
	TSBP_ARROWBTNHORZ = 1,
	TSBP_ARROWBTNVERT = 2,
	TSBP_THUMBBTNHORZ = 3,
	TSBP_THUMBBTNVERT = 4,
	TSBP_PANINDICATORHORZ = 5,
	TSBP_PANINDICATORVERT = 6,
	TSBP_LOWERTRACKHORZ = 7,
	TSBP_LOWERTRACKVERT = 8,
	TSBP_UPPERTRACKHORZ = 9,
	TSBP_UPPERTRACKVERT = 10,
};

#define TOUCHSCROLLBARSTYLEPARTS TOUCHSCROLLBARPARTS;

enum ARROWBTNHORZSTATES {
	TABSH_LEFTNORMAL = 1,
	TABSH_LEFTHOVER = 2,
	TABSH_LEFTPRESSED = 3,
	TABSH_LEFTDISABLED = 4,
	TABSH_RIGHTNORMAL = 5,
	TABSH_RIGHTHOVER = 6,
	TABSH_RIGHTPRESSED = 7,
	TABSH_RIGHTDISABLED = 8,
	TABSH_LEFTFOCUS = 9,
	TABSH_RIGHTFOCUS = 10,
};

enum ARROWBTNVERTSTATES {
	TABSV_UPNORMAL = 1,
	TABSV_UPHOVER = 2,
	TABSV_UPPRESSED = 3,
	TABSV_UPDISABLED = 4,
	...
	TABSV_DOWNHOVER = 6,
	TABSV_DOWNPRESSED = 7,
	TABSV_DOWNDISABLED = 8,
	TABSV_UPFOCUS = 9,
	TABSV_DOWNFOCUS = 10,
};

enum THUMBBTNHORZSTATES {
	TTSH_NORMAL = 1,
	TTSH_HOVER = 2,
	TTSH_PRESSED = 3,
	TTSH_DISABLED = 4,
...
enum PANINDICATORHORZSTATES {
	TPIH_NORMAL = 1,
};

enum PANINDICATORVERTSTATES {
	TPIV_NORMAL = 1,
};

enum TOUCHSCROLLBARSTYLESTATES {
	TSCRBS_NORMAL = 1,
	TSCRBS_HOT = 2,
	TSCRBS_DISABLED = 3,
};
